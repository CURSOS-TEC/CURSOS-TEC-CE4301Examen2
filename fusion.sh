...
export BENCHMARK=/home/SharedData/baseFusionLoop # Relativo al contenedor
export BENCHMARK2=/home/SharedData/optFusionLoop # Relativo al contenedor
export META_CPU_TYPE=TimingSimpleCPU
export META_FOLDER_NAME=loopFusionTest
export META_WORK_RESULTS=/home/SharedData/loopFusionTest
export META_WORK_DIR_BASE=/home/SharedData/loopFusionTest/fusionBase
export META_WORK_DIR_OPT=/home/SharedData/loopFusionTest/fusionOpt
...
(time $OPT -d "./${META_FOLDER_NAME}/fusionBase/m5out${testIndex}/"  $PY -c $BENCHMARK -o $((2**testIndex)) --cpu-type=$META_CPU_TYPE --caches --l2cache --l1d_size=256kB --l1i_size=256kB --l2_size=1MB --l1d_assoc=2 --l1i_assoc=2 --l2_assoc=1 --cacheline_size=64) &> /dev/null 2>&1
(time $OPT -d "./${META_FOLDER_NAME}/fusionOpt/m5out${testIndex}/"  $PY -c $BENCHMARK2 -o $((2**testIndex)) --cpu-type=$META_CPU_TYPE --caches --l2cache --l1d_size=256kB --l1i_size=256kB --l2_size=1MB --l1d_assoc=2 --l1i_assoc=2 --l2_assoc=1 --cacheline_size=64) &> /dev/null 2>&1
...
python3 viewer2.py --xtitle "${META_XAXIS}"  --ytitle "${META_YAXIS}" --xscale "log" --yscale "linear" --xbase 2 --ybase 10 --inputfolder "$META_WORK_RESULTS"
